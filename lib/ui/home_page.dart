...
class _HomePageState extends State<HomePage> {
  ...
  //Linha de Pesquisa
  String _search;
  //Numero de Itens mostrados na pesquisa.
  int _offset = 0;



  //Funcao responsaveis por fazer a requisicao
  ...
  Widget barraDePesquisa(){
    return Padding(
      ...
      child: TextField(
        ...
        onSubmitted: _realizaPesquisa,
      ),
    );
  }

  Widget gifBuilder(context, snapshot){
